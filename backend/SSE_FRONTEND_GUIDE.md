...
function getEventDescription(type) {
    switch (type) {
        case "NEW_BID": return "A freelancer just placed a bid.";
        case "BID_STATUS_UPDATE": return "Check your bid status.";
        case "JOB_MATCH": return "A new job matches your skills!";
